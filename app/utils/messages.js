...
const LOCALES = {
    ...
    lesson: {
        messages: {
            ...
            missingSchedule: 'Не вдалося отримати розклад.',
            notBinded: {
    ...
    about: {
        messages: {
            message: '' +
                ...
                'Звертайтесь до <a href="t.me/SleepyG11">@SleepyG11</a> або допоможіть боту стати краще через <a href="https://github.com/SleepyG11/Rozklad.KPI">GitHub</a>!\n' +
                '\n' +
    ...
    help: {
        ...
        messages: {
            ...
            links: '' +
                ...
                '\n' + 
                'Також бот має можливість додавати посилання на пари зі звичайних повідомлень, але лише при наявності відповідних прав. ' + 
