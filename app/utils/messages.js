...
const LOCALES = {
    ...
    link: {
        placeholders: {
            ...
            directive: {
                linkUrl: 'Посилання на пару Zoom або Meet'
            }
        },
        buttons: {
            stageStart: {
    ...
    // faq: {
    //     buttons: {
    //         notifs: 'Оповіщення про пару?',
    //         links: 'Посилання на пару?',
    //     },
    //     messages: {
    //         notifs: '' +
    //             'За 15 хвилин або на початок пари, бот може нагадати Вам про неї, надіславши оповіщення до чату.\n' +
    //             'Оповіщення має вигляд команди /next. Працює як у приватних, так і групових чатах.\n' +
    //             'Якщо пара дистанційна, особливо корисно буде додати посилання на неї, щоб мати змогу швидко під\'єднатись.\n' +
    //             '\n' +
    //             'За замовчуванням оповіщення вимкнені, але Ви це можете налаштувати у /settings.'
    //         ,
    //         links: '' +
    //             'Більша частина пар останнім часом є дистанційними, на які потрібні посилання на Zoom абщ Meet.\n' +
    //             'Зберігати посилання та шукати відповідне буває важко, але бот це може робити за вас!\n' +
    //             ''
    //     }
    // }
}
