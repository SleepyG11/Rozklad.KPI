...
const LOCALES = {
    ...
    start: {
        messages: {
            ...
            message: '' +
                'Привіт! Я бот, який хоче допомогти Вам та Вашій групі слідкувати за розкладом у КПІ в Telegram!\n' + 
                'Які пари зараз, сьогодні, завтра, цього або наступного тижня - одразу у Вашому чаті, ' + 
                'навіть коли http://roz.kpi.ua не працює, а https://schedule.kpi.ua не оновлює розклад!\n' +
                '\n' + 
                '- Використовуйте в особистих повідомленнях, або додайте мене до свого чату групи;\n' + 
                '- Налаштуйте групу, роклад якої Вам потрібен, командою /bind;\n' + 
